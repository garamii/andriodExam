...
import com.example.android.androidexam.calendar.database.facade.ScheduleFacade;
                ...
                builder.setPositiveButton("수정", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (mScheduleFacade.modifySchedule(schedule) != 0) {
                            Toast.makeText(CalendarActivity.this, "수정 하였습니다", Toast.LENGTH_SHORT).show();
                            loadSchedule(mCalendarAdapter.getSelectedPosition());

                        } else {
                            Toast.makeText(CalendarActivity.this, "수정 실패 하엿습니다", Toast.LENGTH_SHORT).show();
                        }
