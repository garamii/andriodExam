...
package com.example.android.androidexam.calendar.database.facade;
...
import com.example.android.androidexam.calendar.database.contract.ScheduleContract;
import com.example.android.androidexam.calendar.database.helper.ScheduleDbHelper;
...
public class ScheduleFacade {
     ...
     * 스케쥴 수정
     *
     * @param schedule 기존 데이터에 변경 할 값을 세팅 해서 받아야 함
    ...
    public int modifySchedule(Schedule schedule) {
        ...
        String[] whereArgs = {schedule.getId() + ""};
